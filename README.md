...
#### **`STIMULI`**
Stimuli used in the task. From the THINGS dataset. Also included with STIMULI: `ImagevsLure.pdf` to visualize all stimuli. Lures were AI generated, and aimed to keep difficulty at a medium level across all images. 
